(function (r, o) {
    ...
    var z = (r, o, d) => (o in r ? D(r, o, { enumerable: !0, configurable: !0, writable: !0, value: d }) : (r[o] = d));
    ...
    var v = 0,
        ...
        T = function () {
            ...
            return (
                ...
                (e.style.paddingRight = "".concat(s, "px")),
                function () {
            ...
            return (
                ...
                function () {
                    (e.style.height = n.height || ""),
                        ...
                        ["top", "width", "height", "overflow", "position"].forEach(function (l) {
                            t.style[l] = i[l] || "";
                        }),
                        M ? window.scrollTo({ top: s, behavior: "instant" }) : window.scrollTo(0, s);
                }
            );
        },
        g = function (e) {
    ...
    class y {
        constructor(e) {
            ...
            u(this, "isBusy", !1);
            u(this, "config", { linkAttributeName: "data-hystmodal", closeOnEsc: !0, closeOnOverlay: !0, closeOnButton: !0, catchFocus: !0, isStacked: !1, backscroll: !0, waitTransitions: !1, fixedSelectors: ["[data-hystfixed]"] });
            u(this, "focusElements", [
                "a[href]",
                "area[href]",
        ...
        async open(e, t = this.config.isStacked, s = null) {
            ...
            const l = getComputedStyle(i).getPropertyValue("--hystmodal-zindex"),
                a = { element: i, openedWindow: i, starter: s, zIndex: n ? n.zIndex + this.openedModals.length : parseInt(l, 10), config: this.config, isOpened: !1 };
        ...
        closeObj(e, t = !1, s = !1, n = !0) {
            return new Promise((i) => {
                ...
                e.element.setAttribute("aria-hidden", "false"),
                    (this.openedModals = this.openedModals.filter((a) => a.element !== e.element)),
                    setTimeout(
                        () => {
                            e.element.classList.remove("hystmodal--animated"),
                                e.element.classList.remove("hystmodal--moved"),
                                (e.element.style.zIndex = ""),
                                this.config.backscroll && !this.openedModals.length && t && (_(), this.bodyScrollControl(e, "closing"), (this.isBodyLocked = !1)),
                                this.config.catchFocus && e.starter && n && e.starter.focus(),
